...
let handler = async (m, {
    ...
    try {
        ...
        for (let i = 0; i < words.length; i++) {
            ...
            const res = await (await axios.get(`https://api.botcahx.eu.org/api/maker/brat-video?text=${encodeURIComponent(text.substring(0, 151))}&apikey=${btz}`, { responseType:  "arraybuffer" })).data;
        ...
        const stik = await createSticker(false, outputVideoPath, "By Elaina - MD", 20)
